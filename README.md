...
![client_result](./src/screenshot/result1.png)
For controller.py
`mininet> h1 iperf -s -u -i 1 –p 5566 > ./out/result2 &`
`mininet> h2 iperf -c 10.0.0.1 -u –i 1 –p 5566`
![client_result](./src/screenshot/result2.png)

**6. Exit mininet & Ryu and clean it**
...
3. Mininet Topology
    ...
    Here's an example about link s1-s3
...
4. Ryu Controller
    ...
    ![controller](./src/screenshot/example.png)
...
6. Why need to set "`ip_proto=17`" in the flow entry?
   ...
   In this lab, we use UDP to test the SDN.(in iPerf, we use argument `-u`)
